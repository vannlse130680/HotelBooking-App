 ...
 * @author Acer
 */
public class SearchByHotelAreaAction {
    ...
    private String searchByHotelAreaError;
    private boolean willSearch;

    public SearchByHotelAreaAction() {
    }
    ...
    public String execute() throws Exception {
        ...
        if (hotelAreaSearch.trim().isEmpty() || checkInDate.trim().isEmpty() || checkOutDate.trim().isEmpty() || amount.trim().isEmpty()) {
            foundError = true;
            searchByHotelAreaError = "Please enter full infor to search!";
        } else {
            willSearch = true;
        }
        if (!foundError) {
            ...
            dao.searchByHotelArea(hotelAreaSearch, checkInDate, checkOutDate, amountNum);
    ...
    public String getSearchByHotelAreaError() {
        return searchByHotelAreaError;
    }

    public void setSearchByHotelAreaError(String searchByHotelAreaError) {
        this.searchByHotelAreaError = searchByHotelAreaError;
    }
